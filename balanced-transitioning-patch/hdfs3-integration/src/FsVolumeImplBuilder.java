...
public class FsVolumeImplBuilder {
  ...
  public FsVolumeImplBuilder setDataset(FsDatasetImpl dataset) {
    this.dataset = dataset;
    return this;
  }

  public FsVolumeImplBuilder setStorageID(String id) {
    this.storageID = id;
    return this;
  }

  public FsVolumeImplBuilder setStorageDirectory(StorageDirectory sd) {
    this.sd = sd;
    return this;
  }

  public FsVolumeImplBuilder setConf(Configuration conf) {
    this.conf = conf;
    return this;
  }
  ...
  @VisibleForTesting
  public FsVolumeImplBuilder setUsage(DF newUsage) {
    this.usage = newUsage;
    return this;
  }
