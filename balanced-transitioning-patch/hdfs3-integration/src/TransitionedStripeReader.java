...
/**
 * The reader for reading a AlignedStripe
 * which consist of blocks from multiple files
 */
class TransitionedStripeReader extends StripeReader {

  private final short usefulDataBlkNum;

  TransitionedStripeReader(AlignedStripe alignedStripe,
    ...
    usefulDataBlkNum = (short)(targetBlocks.length - parityBlkNum);
  }
