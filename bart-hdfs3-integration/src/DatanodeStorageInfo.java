...
public class DatanodeStorageInfo {
  ...
  DatanodeStorageInfo(DatanodeDescriptor dn, DatanodeStorage s, boolean isParity) {
    this(dn, s.getStorageID(), s.getStorageType(), s.getState(), isParity);
  }

  DatanodeStorageInfo(DatanodeDescriptor dn, String storageID,
      StorageType storageType, State state, boolean isParity) {
    this.dn = dn;
    this.storageID = storageID;
    this.storageType = storageType;
    this.state = state;
  ...
  void setEcStorageType(boolean isParity) {
    this.isParity = isParity;
  }
  ...
  public boolean getECStorageType() {
    return isParity;
  }
