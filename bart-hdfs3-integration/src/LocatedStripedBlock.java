...
public class LocatedStripedBlock extends LocatedBlock {
  ...
  public LocatedStripedBlock(ExtendedBlock b, DatanodeInfo[] locs,
      ...
      long[] blockIDs, long[] genStamps, byte[] indices, long startOffset, boolean corrupt,
      DatanodeInfo[] cachedLocs) {
    super(b, locs, storageIDs, storageTypes, startOffset, corrupt, cachedLocs, poolIDs, blockIDs, genStamps);
  ...
  public String toString() {
    String returnString = getClass().getSimpleName() + "{" + getBlock()
    ...
    if (isBlockIDsEmpty()) {
      ...
      returnString +=  "; blockIds=" + Arrays.asList(super.getBlockIDs())
          + "; poolIds=" + Arrays.asList(super.getPoolIDs())
          + "; genStamps=" + Arrays.asList(super.getGenStamps())
          + "}";
    }
