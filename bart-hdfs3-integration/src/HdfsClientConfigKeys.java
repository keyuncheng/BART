...
public interface HdfsClientConfigKeys {
  ...
  String  DFS_COORDINATOR_KERBEROS_PRINCIPAL_KEY =
      "dfs.coordinator.kerberos.principal";
  String  DFS_COORDINATOR_READAHEAD_BYTES_KEY = "dfs.coordinator.readahead.bytes";
  long DFS_COORDINATOR_READAHEAD_BYTES_DEFAULT = 4 * 1024 * 1024; // 4MB
