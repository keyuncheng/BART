...
public class DatanodeInfo extends DatanodeID implements Node {
  ...
  protected DatanodeInfo(DatanodeInfo from) {
    ...
    this.poolID = from.getPoolID();
    this.blockID = from.getBlockID();
    this.genStamp = from.getGenStamp();
  }
  ...
  private DatanodeInfo(final String ipAddr, final String hostName,
      ...
      final AdminStates adminState, final String upgradeDomain,
      final long lastBlockReportTime, final long lastBlockReportMonotonic,
      final int blockCount, final String poolID, final long blockID, final long genStamp) {
    super(ipAddr, hostName, datanodeUuid, xferPort, infoPort, infoSecurePort,
        ipcPort);
    this.capacity = capacity;
    this.dfsUsed = dfsUsed;
  ...
  public String getDatanodeReport() {
    ...
    boolean blockUseful = getInfoUseful();
    ...
    buffer.append("Configured Capacity: ").append(c).append(" (")
        ...
        .append("Block useful: ").append(blockUseful).append("\n");
  ...
  *        maintenance mode until in the unit of milliseconds.   */
  ...
  public void setInfoUseful(boolean useful) {
    super.setInfoUseful(useful);
  }

  public boolean getInfoUseful() {
    return super.getInfoUseful();
  }
  ...
  public static class DatanodeInfoBuilder {
    ...
    public DatanodeInfoBuilder setPoolId(String poolID) {
      this.poolID = poolID;
      return this;
    }

    public DatanodeInfoBuilder setBlockId(long blockID) {
      this.blockID = blockID;
      return this;
    }

    public DatanodeInfoBuilder setGenStamp(long genStamp) {
      this.genStamp = genStamp;
      return this;
    }
    ...
    public DatanodeInfo build() {
      return new DatanodeInfo(ipAddr, hostName, datanodeUuid, xferPort,
          ...
          numBlocks, poolID, blockID, genStamp);
    }
  }
}
