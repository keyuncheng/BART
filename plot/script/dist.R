...
if (T) {
        x1 <- read.table("../data/dist_3_2.dat", header=TRUE)
        library(ggplot2)
        library(grid)
        library(extrafont)
        font_import()
        ...
        myggsave("../pdf/dist_3_2.pdf", width=4.2, height=3,device=cairo_pdf)
}

if (T) {
        x1 <- read.table("../data/receive_3_2.dat", header=TRUE)
        library(ggplot2)
        library(grid)
        library(extrafont)
        font_import()
        ...
        myggsave("../pdf/receive_3_2.pdf", width=4.2, height=3,device=cairo_pdf)
}

if (T) {
        x1 <- read.table("../data/send_3_2.dat", header=TRUE)
        library(ggplot2)
        library(grid)
        library(extrafont)
        font_import()
        ...
        myggsave("../pdf/send_3_2.pdf", width=4.2, height=3,device=cairo_pdf)
}
