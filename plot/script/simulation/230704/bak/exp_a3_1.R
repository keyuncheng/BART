if (T) {
    ...
    ggplot(x1, aes(x = num_nodes, y = max_load, col = method, linetype = method, shape = method, fill = method)) +
    ...
    ggsave("../../../pdf/simulation/230704/exp_a3_1.pdf", width=6, height=4, device=cairo_pdf)
}
