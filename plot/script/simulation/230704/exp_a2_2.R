if (T) {
    ...
    scale_y_continuous(expand = c(0,0),limits=c(0,1250), breaks=c(0,200,400,600,800,1000,1200)) +
    ...
    ggsave("../../../pdf/simulation/230704/exp_a2_2.pdf", width=5.5, height=4, device=cairo_pdf)
}