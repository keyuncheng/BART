# sm_g tasks
if (T) {
    x1<-read.table("../../../data/simulation/230704/exp_a1_1.dat", header=TRUE)
    library(ggplot2)
    library(grid)
    library(extrafont)
    font_import()
    ...
    scale_fill_manual(name=element_blank(),
                    ...
                    values=c(a='#19376D',b='#2187c2',c='#ff0000')) +
    ...
    ggsave("../../../pdf/simulation/230704/exp_a1_1.pdf", width=9, height=4, device=cairo_pdf)
}
