if (T) {
    x1<-read.table("../../../data/simulation/230708/exp_a3_4.dat", header=TRUE)
    library(ggplot2)
    library(grid)
    library(extrafont)
    font_import()
    ...
    scale_y_continuous(expand = c(0,0),limits=c(0,410), breaks=c(0,100,200,300,400)) +
    ...
    ggsave("../../../pdf/simulation/230708/exp_a3_4.pdf", width=5.5, height=4, device=cairo_pdf)
}