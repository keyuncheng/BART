if (T) {
    ...
    ggplot(x1, aes(x=network_id, y=max_time/1000, group=method_id, shape=method_id, color=method_id)) +
    ...
    scale_x_discrete(breaks=c("a","b","c","d"),
                    labels=c("1", "2", "5", "10")) +
    scale_y_continuous(expand = c(0,0),limits=c(0, 82), breaks=c(0,20,40,60,80)) +
    ...
    theme(legend.position=c(0.5,0.9), legend.direction="vertical", legend.key=element_blank())
    ggsave("../../../pdf/aliyun/230704/exp_b3_1.pdf", width=5, height=4, device=cairo_pdf)
}